-- 创建拓源公司主营业务边际贡献率结构与质量表
CREATE TABLE IF NOT EXISTS tuoyuan_main_business_contribution_rate (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='拓源公司主营业务边际贡献率结构与质量';
